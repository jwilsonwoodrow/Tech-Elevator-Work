...
namespace Shapes
{
    ...
    class DrawingCLI : ConsoleMenu
    {
         ...
         * Hold IDrawable objects 
        ********************************************************************/
        List<IDrawable> drawableThings = new List<IDrawable>();
        #endregion
        ...
        public DrawingCLI()
        {
            this.AddOption("Add a Circle", AddCircle)
                ...
                .AddOption("Add a Label", AddText)
                .AddOption("Draw the Canvas", DrawCanvas)
                .AddOption("List All Shapes", ListShapes)
                .AddOption("Calculate Total Area", ShowTotalArea)
        ...
        private MenuOptionResult AddCircle()
        {
            ...
            drawableThings.Add(new Circle(x, y, color, filled, radius));
        ...
        private MenuOptionResult AddRectangle()
        {
            ...
            ConsoleColor color = GetColor();
            bool filled = GetBool("Do you want the shape filled? ", false);
            drawableThings.Add(new Rectangle(x, y, color, filled, width, height));
        ...
        {
            // We draw "things that are drawable"
        ...
        /********************************************
        * Method *private MenuOptionResult AddText()*
        ...
        ********************************************/
        private MenuOptionResult AddText()
        {
            ...
            ConsoleColor color = GetColor();
            drawableThings.Add(new Text(x, y, color, label));
            Console.WriteLine("New Label was added");
            return MenuOptionResult.WaitAfterMenuSelection;
        }
