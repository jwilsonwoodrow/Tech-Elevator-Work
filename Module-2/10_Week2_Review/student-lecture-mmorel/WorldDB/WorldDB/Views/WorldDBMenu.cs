...
namespace WorldDB.Views
{
    ...
    public class WorldDBMenu : ConsoleMenu
    {
        ...
        {
            // Get the list of countries for all continents (GetCountries)
        ...
        private MenuOptionResult ListCountriesForContinent()
        {
            ...
            // Get the list of countries for a continent (GetCountries)
        ...
        private MenuOptionResult SelectACountry()
        {
            ...
            // Lookup the country (GetCountryByCode) and pass that into the country submenu
            ...
            // Pass country into country menu.  We are going to need a CityDAO also!
            CountryMenu menu = new CountryMenu(country, cityDAO, countryLanguageDAO);
            menu.Show();
